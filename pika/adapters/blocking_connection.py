...
class _TimerEvt:
    ...
    def __repr__(self):
        return "<{} timer_id={} callback={}>".format(
            self.__class__.__name__, self.timer_id, self._callback
        )
...
class _ConsumerCancellationEvt(_ChannelPendingEvt):
    ...
    def __repr__(self):
        return "<{} method_frame={!r}>".format(
            self.__class__.__name__, self.method_frame
        )
...
class BlockingChannel:
    ...
    def _cleanup(self):
        ...
        self._pending_events = deque()
        self._consumer_infos = dict()
        LOGGER.warning("_cleanup: self._queue_consumer_generator is None")
        self._queue_consumer_generator = None
    ...
    def consume(
        ...
        if self._queue_consumer_generator is not None:
            ...
            try:
                ...
                self._queue_consumer_generator = None
                LOGGER.warning(
                    f"Exception {e} happened, _queue_consumer_generator is None"
                )
                raise
        ...
        while self._queue_consumer_generator is not None:
            ...
            if self._queue_consumer_generator.pending_events:
                ...
                if type(evt) is _ConsumerCancellationEvt:  # pylint: disable=C0123
                    ...
                    LOGGER.warning(
                        "_ConsumerCancellationEvt happened, _queue_consumer_generator is None"
                    )
                    self._queue_consumer_generator = None
                    break
                else:
    ...
    def cancel(self):
        ...
        try:
            ...
            LOGGER.warning("finally: _queue_consumer_generator is None")
            self._queue_consumer_generator = None
